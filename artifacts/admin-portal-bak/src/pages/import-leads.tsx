...
import { Upload, RefreshCw, Play, CheckCircle, XCircle, Clock } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Import from Google Sheets or manually trigger email queue processing</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 space-y-5">
          ...
          <div className="bg-sidebar border rounded-xl shadow-sm p-6">
            <h2 className="font-semibold text-sidebar-foreground mb-1">Process Email Queue</h2>
            <p className="text-sm text-sidebar-foreground/60 mb-4">
              Click the button below to manually trigger sending the next email in sequence for all active leads.
              In production, set up a daily cron job calling <code className="bg-white/10 px-1 rounded font-mono text-xs">POST /api/admin/email/process-queue</code>
            </p>
            ...
            <Button onClick={handleProcessQueue} disabled={processing} variant="secondary" className="gap-2 bg-primary hover:bg-primary/90 text-primary-foreground border-none">
              {processing ? (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-left py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Accepted Column Names</th>
                </tr>
              </thead>
              <tbody className="divide-y text-sm">
                <tr>
                  <td className="py-2.5 text-foreground font-medium">Email <span className="text-red-500">*</span></td>
                  <td className="py-2.5 font-mono text-xs text-muted-foreground">email</td>
                </tr>
                <tr>
                  <td className="py-2.5 text-foreground font-medium">First Name</td>
                  <td className="py-2.5 font-mono text-xs text-muted-foreground">first_name, firstname, first name</td>
                </tr>
                <tr>
                  <td className="py-2.5 text-foreground font-medium">Last Name</td>
                  <td className="py-2.5 font-mono text-xs text-muted-foreground">last_name, lastname, last name</td>
                </tr>
                <tr>
                  <td className="py-2.5 text-foreground font-medium">Phone</td>
                  <td className="py-2.5 font-mono text-xs text-muted-foreground">phone, mobile, cell</td>
                </tr>
                <tr>
                  <td className="py-2.5 text-foreground font-medium">Company</td>
                  <td className="py-2.5 font-mono text-xs text-muted-foreground">company, organisation, organization</td>
                </tr>
              </tbody>
            </table>
          </div>
